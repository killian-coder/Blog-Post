        ...
        <nav class="navbar fixed-top navbar-expand-lg navbar-light white scrolling-navbar">
            <div class="container">
                ...
                <a class="navbar-brand waves-effect" href="https://mdbootstrap.com/docs/jquery/" target="_blank">
                    <strong class="blue-text">Killian Blog Post</strong>
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link waves-effect" href="https://mdbootstrap.com/docs/jquery/" target="_blank">About Killian Media</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <ul class="navbar-nav nav-flex-icons">
                        ...
                        <li class="nav-item">
                            <a href="https://github.com/mdbootstrap/bootstrap-material-design" class="nav-link border border-light rounded waves-effect"
                                target="_blank">
                                <i class="fa fa-github mr-2"></i>killian
                            </a>
                        </li>
                    </ul>
        ...
        <div class="container">
            ...
            <section class="card wow fadeIn" style="background-image: url(https://mdbootstrap.com/img/Photos/Others/gradient1.jpg);">
                ...
                <div class="card-body text-white text-center py-5 px-5 my-5">
                    ...
                    <h1 class="mb-4">
                        <strong>Learn Bootstrap 4 with Killian</strong>
                    </h1>
                    <p>
                ...
                <div class="row mb-4 wow fadeIn">
                    ...
                    <div class="col-lg-4 col-md-12 mb-4">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <!--Title-->
                                <h4 class="card-title">Killian Quick Start</h4>
                                <!--Text-->
                ...
                <div class="row mb-4 wow fadeIn">
                    ...
                    <div class="col-lg-4 col-md-12 mb-4">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <!--Title-->
                                <h4 class="card-title">Killian Blog with Angular</h4>
                                <!--Text-->
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <!--Title-->
                                <h4 class="card-title">Killian Blog with React</h4>
                                <!--Text-->
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <!--Title-->
                                <h4 class="card-title">KillianBlog with Vue</h4>
                                <!--Text-->
